...
| [**3D目标检测**](examples/vision/keypointdetection)                                                                                     | [**PP-TS**](https://github.com/PaddlePaddle/FastDeploy/issues/6)                                                                                        |  [**车载垃圾分类系统**](examples/text)                                                                                                                                                                                                           |[**野生动物及制品分类**](examples/audio/pp-tts)  
